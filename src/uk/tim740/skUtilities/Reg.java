...
class Reg {
    ...
    static void utils() {
        ...
        Skript.registerExpression(ExprDayOfWeek.class, String.class, ExpressionType.PROPERTY, "[skutil[ities] ]day of[ the] week of %string%", "[skutil[ities] ]day of[ the] week of %string%");
